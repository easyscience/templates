...
**key parameters** and **workflow steps** required for using EasyTemplates
effectively.
...
- [Parameters](#) – Describes how parameters are structured, named, and
  accessed within the EasyTemplates.
- [First Steps](#) – Shows how to begin using EasyTemplates in Python
