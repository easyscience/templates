# Contributing to EasyTemplates

Thank you for your interest in contributing to **EasyTemplates**!
...
1. Open the repository page: `https://github.com/easyscience/templates`
...
4. Add the original repository as `upstream`:
   ...
   ```bash
   git remote add upstream https://github.com/easyscience/templates.git
   ```
...
Thank you for contributing to EasyTemplates and the EasyScience
ecosystem!
